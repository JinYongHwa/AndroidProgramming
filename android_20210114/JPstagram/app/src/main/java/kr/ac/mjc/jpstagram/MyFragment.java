...
public class MyFragment  extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Switch allowAlarmSw=view.findViewById(R.id.allow_alarm_sw);
        allowAlarmSw.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                String email=auth.getCurrentUser().getEmail();
                firestore.collection("User").document(email)
                        .update("allow",isChecked);
            }
        });
